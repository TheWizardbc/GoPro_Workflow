# -------------------------------------------------------------------------
# SCRIPT NAME: GoProMax_Hero_Workflow_v4.1.3.py
# VERSION: 4.1.3 - Fix Mapillary upload and translate remaining remarks to English
...
class MapillaryApp:
    def __init__(self, master, system_bg_color):
        ...
        master.title("GoPro Max & Hero - Mapillary & SVS Workflow Tool (V4.1.3)")
    ...
    def create_about_tab(self, tab):
        ...
        tk.Label(header_frame, text="Version 4.1.3 (Max 1 & 2 + Hero Edition)", font=('Arial', 10, 'bold'), fg='#666', bg=self.system_bg_color).pack()
        ...
        msg_hero = (
            "New in V4.1.3. This dedicated workflow processes standard GoPro Hero MP4 files directly for Mapillary. "
